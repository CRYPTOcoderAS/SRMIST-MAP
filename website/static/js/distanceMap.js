...
/*global google, console, document, Float32Array, XMLHttpRequest, alert */
...
function initMap() {
  ...
  var
    ...
    markerListInfo = [
      ['Boyer', '<h4>Boyer Hall</h4> <h5> SAB Lost Films </h5>' +
        'Friday: 6 and 9 PM <br>' +
        'Saturday: 3, 6 and 9 PM'
      ],

      ['Library', '<h4> Murray Library </h4> <h5> Opening Hours </h5>' +
      ...
      ['Lottie', '<h4> Lottie </h4> <h5> Opening Hours </h5>' +
      ...
      ['Gym', '<h4> Falcon Fitness Center </h4> <h5> Opening Hours </h5>' +
      ...
      ['Fry D', '<h4> Fry D Apartments </h4> <h5> Visitation Hours </h5>' +
        'Sun - Thurs: Noon - Midnight <br>' +
        'Fri - Sat: Noon - 1 AM'
      ],

      ['Rafiki', '<h4> Rafiki House </h4> <h5> People </h5>' +
        'Katrina Chan<br>' +
        'Kucha Ganeng <br>' +
        'Abigail Hing <br>' +
        'Jodie Howard <br>' +
      ...
      ['Union', '<h4> Union Cafe </h4> <h5> Opening Hours </h5>' +
      ...
      ['Frey', '<h4> Frey Hall </h4> <h5> Office Hours </h5>' +
        'CIS 487: Dr. Owen: Mon - Fri: 1 PM - 2 PM'
      ],

      ['High Center', '<h4> High Center </h4> <h5> Piano Practice Room Opening Hours </h5>' +
        '..to be included..'
      ],

      ['Field', '<h4> Field </h4> <h5> Ultimate Training Times </h5>' +
        'Tues: 4:30 PM - 6:30 PM <br>' +
        'Thurs: 4:30 PM - 6:30 PM'
      ],

      ['Parking Lot', '<h4> Parking Lot </h4> <h5> Resources</h5>' +
  ...
  // To mark the points that the user clicks
  circle = {
  ...
  function createStartButton() {
    var startButton, startButtonText;

    startButton = document.createElement("BUTTON");
    startButton.style.fontSize = "16px";
    startButtonText = document.createTextNode("START");
    startButton.appendChild(startButtonText);

    document.getElementById("startButtonDiv").appendChild(startButton);
  ...
  function createClearButton() {
    var clearButton, clearButtonText;

    clearButton = document.createElement("BUTTON");
    clearButton.style.fontSize = "16px";
    clearButtonText = document.createTextNode("CLEAR");
    ...
    clearButton.addEventListener('click', function() {
      ...
      document.getElementById("distanceHereDiv").innerHTML = ".";

    }, false);
  }

  function createDoneButton() {
    var doneButton, doneButtonText;
    ...
    document.getElementById("doneButtonDiv").appendChild(doneButton);

    doneButton.addEventListener('click', function() {
      var i, latLngA, latLngB;
      if (getInfoBool === true) {
        for (i = 0; i < (distanceArray.length - 1); i++) {
          latLngA = distanceArray[i];
          latLngB = distanceArray[i + 1];
          distanceSum = distanceSum + google.maps.geometry.spherical.computeDistanceBetween(latLngA, latLngB);
        }

        distanceSum = Math.round(distanceSum * 100) / 100;
        document.getElementById("distanceHereDiv").innerHTML = distanceSum + " meters";

        // Clear markers and reset everything.
        distanceSum = 0;
        distanceArray = [];
